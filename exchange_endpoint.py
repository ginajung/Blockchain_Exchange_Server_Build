...
def get_algo_keys():
    ...
    mnemonic_secret = "exist exist soap aspect job word upgrade shift misery raise limit describe sport club toddler liar pig danger face blossom stand conduct mistake elephant arrive"
