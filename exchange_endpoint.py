...
def get_algo_keys():
    ...
    mnemonic_secret = "want quiz moral bread repeat embark shed steak book joy fetch pilot shift floor minimum poverty index yard cannon divorce fatal angry mistake abandon voyage"
